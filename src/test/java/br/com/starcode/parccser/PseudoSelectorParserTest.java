...
public class PseudoSelectorParserTest {
    ...
    public void pseudoClassSelector() throws Exception {
        ...
        Assert.assertEquals("pseudoSelector=PSEUDO_CLASS|enabled", l.getLista().get(2));
    ...
    public void pseudoElementSelector() throws Exception {
        ...
        Assert.assertEquals("beginGroup=0", l.getLista().get(0));
        Assert.assertEquals("typeSelector=input", l.getLista().get(1));
        Assert.assertEquals("pseudoSelector=PSEUDO_ELEMENT|anything", l.getLista().get(2));
    ...
    public void specialPseudoElementSelector() throws Exception {
        ...
        Assert.assertEquals("beginGroup=0", l.getLista().get(0));
        Assert.assertEquals("typeSelector=input", l.getLista().get(1));
        Assert.assertEquals("pseudoSelector=PSEUDO_ELEMENT|first-line", l.getLista().get(2));
        ...
        Assert.assertEquals("beginGroup=0", l.getLista().get(0));
        Assert.assertEquals("typeSelector=input", l.getLista().get(1));
        Assert.assertEquals("pseudoSelector=PSEUDO_ELEMENT|first-letter", l.getLista().get(2));
        ...
        Assert.assertEquals("beginGroup=0", l.getLista().get(0));
        Assert.assertEquals("typeSelector=input", l.getLista().get(1));
        Assert.assertEquals("pseudoSelector=PSEUDO_ELEMENT|before", l.getLista().get(2));
        ...
        Assert.assertEquals("beginGroup=0", l.getLista().get(0));
        Assert.assertEquals("typeSelector=input", l.getLista().get(1));
        Assert.assertEquals("pseudoSelector=PSEUDO_ELEMENT|after", l.getLista().get(2));
    ...
    public void pseudoClassMultiple() throws Exception {
        ...
        Assert.assertEquals("typeSelector=input", l.getLista().get(1));
        Assert.assertEquals("pseudoSelector=PSEUDO_CLASS|enabled", l.getLista().get(2));
        Assert.assertEquals("pseudoSelector=PSEUDO_CLASS|hover", l.getLista().get(3));
    ...
    public void pseudoClassParameter() throws Exception {
        ...
        Assert.assertEquals("beginGroup=0", l.getLista().get(0));
        Assert.assertEquals("typeSelector=input", l.getLista().get(1));
        Assert.assertEquals("pseudoSelector=PSEUDO_CLASS|eq(1)", l.getLista().get(2));
    ...
    public void pseudoClassParameterExpression() throws Exception {
        ...
        Assert.assertEquals("pseudoSelector=PSEUDO_CLASS|eq(2n+1)", l.getLista().get(2));
        ...
        Assert.assertEquals("pseudoSelector=PSEUDO_CLASS|eq(+1.5n+3.5)", l.getLista().get(2));
        ...
        Assert.assertEquals("pseudoSelector=PSEUDO_CLASS|eq(10px)", l.getLista().get(2));
    ...
    public void pseudoClassParameterConstant() throws Exception {
        ...
        Assert.assertEquals("pseudoSelector=PSEUDO_CLASS|eq(n)", l.getLista().get(2));
        ...
        Assert.assertEquals("pseudoSelector=PSEUDO_CLASS|lang(pt-br)", l.getLista().get(2));
