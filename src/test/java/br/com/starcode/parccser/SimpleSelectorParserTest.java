...
public class SimpleSelectorParserTest {
    ...
    public void universal() throws Exception {
        ...
        Assert.assertEquals(4, listener.getList().size());
        Assert.assertEquals("beginGroup=0", listener.getList().get(0));
        Assert.assertEquals("typeSelector=*", listener.getList().get(1));
        Assert.assertEquals("selectorSequence=null|*", listener.getList().get(2));
        Assert.assertEquals("endGroup=0", listener.getList().get(3));
    ...
    public void element() throws Exception {
        ...
        Assert.assertEquals(4, listener.getList().size());
        Assert.assertEquals("beginGroup=0", listener.getList().get(0));
        Assert.assertEquals("typeSelector=table", listener.getList().get(1));
        Assert.assertEquals("selectorSequence=null|table", listener.getList().get(2));
        Assert.assertEquals("endGroup=0", listener.getList().get(3));
    ...
    public void classSelector() throws Exception {
        ...
        Assert.assertEquals(4, listener.getList().size());
        Assert.assertEquals("beginGroup=0", listener.getList().get(0));
        Assert.assertEquals("classSelector=class", listener.getList().get(1));
        Assert.assertEquals("selectorSequence=null|.class", listener.getList().get(2));
        Assert.assertEquals("endGroup=0", listener.getList().get(3));
    ...
    public void idSelector() throws Exception {
        ...
        Assert.assertEquals(4, listener.getList().size());
        Assert.assertEquals("beginGroup=0", listener.getList().get(0));
        Assert.assertEquals("idSelector=identifier", listener.getList().get(1));
        Assert.assertEquals("selectorSequence=null|#identifier", listener.getList().get(2));
        Assert.assertEquals("endGroup=0", listener.getList().get(3));
    ...
    public void attributeSelector() throws Exception {
        ...
        Assert.assertEquals(4, listener.getList().size());
        Assert.assertEquals("beginGroup=0", listener.getList().get(0));
        Assert.assertEquals("attributeSelector=name='test'", listener.getList().get(1));
        Assert.assertEquals("selectorSequence=null|[name='test']", listener.getList().get(2));
        Assert.assertEquals("endGroup=0", listener.getList().get(3));
...
//        Assert.assertEquals("endGroup=0", listener.getLista().get(3));
    ...
    public void childSelector() throws Exception {
        ...
        Assert.assertEquals("beginGroup=0", listener.getList().get(0));
        Assert.assertEquals("idSelector=id", listener.getList().get(1));
        Assert.assertEquals("selectorSequence=null|#id", listener.getList().get(2));
        Assert.assertEquals("classSelector=class", listener.getList().get(3));
        Assert.assertEquals("selectorSequence=>|.class", listener.getList().get(4));
        Assert.assertEquals("endGroup=0", listener.getList().get(5));
    ...
    public void siblingDescendantSelector() throws Exception {
        ...
        Assert.assertEquals("beginGroup=0", listener.getList().get(0));
        Assert.assertEquals("typeSelector=a", listener.getList().get(1));
        Assert.assertEquals("selectorSequence=null|a", listener.getList().get(2));
        Assert.assertEquals("idSelector=id", listener.getList().get(3));
        Assert.assertEquals("selectorSequence=~|#id", listener.getList().get(4));
        Assert.assertEquals("classSelector=class", listener.getList().get(5));
        Assert.assertEquals("selectorSequence= |.class", listener.getList().get(6));
        Assert.assertEquals("endGroup=0", listener.getList().get(7));
    ...
    public void composedSelector() throws Exception {
    	...
    	Assert.assertEquals(7, listener.getList().size());
        Assert.assertEquals("beginGroup=0", listener.getList().get(0));
        Assert.assertEquals("typeSelector=div", listener.getList().get(1));
        Assert.assertEquals("classSelector=class1", listener.getList().get(2));
        Assert.assertEquals("idSelector=id", listener.getList().get(3));
        Assert.assertEquals("classSelector=class2", listener.getList().get(4));
        Assert.assertEquals("selectorSequence=null|div.class1#id.class2", listener.getList().get(5));
        Assert.assertEquals("endGroup=0", listener.getList().get(6));
    ...
    public void attributeMultipleSelector() throws Exception {
        ...
        Assert.assertEquals("beginGroup=0", listener.getList().get(0));
        Assert.assertEquals("typeSelector=*", listener.getList().get(1));
        Assert.assertEquals("attributeSelector=_onlyName", listener.getList().get(2));
        Assert.assertEquals("selectorSequence=null|*[_onlyName]", listener.getList().get(3));
        Assert.assertEquals("endGroup=0", listener.getList().get(4));

        //group 1
        Assert.assertEquals("beginGroup=1", listener.getList().get(5));
        Assert.assertEquals("typeSelector=a", listener.getList().get(6));
        Assert.assertEquals("attributeSelector=href~=https", listener.getList().get(7));
        Assert.assertEquals("selectorSequence=null|a[href~=https]", listener.getList().get(8));
        Assert.assertEquals("endGroup=1", listener.getList().get(9));

        //group 2
        Assert.assertEquals("beginGroup=2", listener.getList().get(10));
        Assert.assertEquals("classSelector=class", listener.getList().get(11));
        Assert.assertEquals("attributeSelector=name|=\"name\"", listener.getList().get(12));
        Assert.assertEquals("selectorSequence=null|.class[name|=\"name\"]", listener.getList().get(13));
        Assert.assertEquals("endGroup=2", listener.getList().get(14));

        //group 3
        Assert.assertEquals("beginGroup=3", listener.getList().get(15));
        Assert.assertEquals("typeSelector=span", listener.getList().get(16));
        Assert.assertEquals("idSelector=composed-id", listener.getList().get(17));
        Assert.assertEquals("attributeSelector=attr=_val", listener.getList().get(18));
        Assert.assertEquals("selectorSequence=null|span#composed-id[attr=_val]", listener.getList().get(19));
        Assert.assertEquals("endGroup=3", listener.getList().get(20));

        //group 4
        Assert.assertEquals("beginGroup=4", listener.getList().get(21));
        Assert.assertEquals("attributeSelector=z-indez*='1'", listener.getList().get(22));
        Assert.assertEquals("selectorSequence=null|[z-indez*='1']", listener.getList().get(23));
        Assert.assertEquals("endGroup=4", listener.getList().get(24));

        //group 5
        Assert.assertEquals("beginGroup=5", listener.getList().get(25));
        Assert.assertEquals("attributeSelector=href", listener.getList().get(26));
        Assert.assertEquals("attributeSelector=data-aria^='1'", listener.getList().get(27));
        Assert.assertEquals("selectorSequence=null|[href][data-aria^='1']", listener.getList().get(28));
        Assert.assertEquals("endGroup=5", listener.getList().get(29));
    ...
    public void adjascentGroupSelector() throws Exception {
    	...
    	Assert.assertEquals(15, listener.getList().size());
        Assert.assertEquals("beginGroup=0", listener.getList().get(0));
        Assert.assertEquals("typeSelector=li", listener.getList().get(1));
        Assert.assertEquals("selectorSequence=null|li", listener.getList().get(2));
        Assert.assertEquals("typeSelector=li", listener.getList().get(3));
        Assert.assertEquals("classSelector=class1", listener.getList().get(4));
        Assert.assertEquals("classSelector=class2", listener.getList().get(5));
        Assert.assertEquals("selectorSequence=+|li.class1.class2", listener.getList().get(6));
        Assert.assertEquals("endGroup=0", listener.getList().get(7));
        Assert.assertEquals("beginGroup=1", listener.getList().get(8));
        Assert.assertEquals("typeSelector=table", listener.getList().get(9));
        Assert.assertEquals("idSelector=id", listener.getList().get(10));
        Assert.assertEquals("selectorSequence=null|table#id", listener.getList().get(11));
        Assert.assertEquals("typeSelector=tr", listener.getList().get(12));
        Assert.assertEquals("selectorSequence= |tr", listener.getList().get(13));
        Assert.assertEquals("endGroup=1", listener.getList().get(14));
